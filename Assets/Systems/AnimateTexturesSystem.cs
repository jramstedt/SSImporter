  ...
  public sealed class AnimateTexturesSystem : SystemBase {
    ...
    protected override void OnUpdate() {
      ...
      foreach (var (textureIndex, material) in mapMaterial) {
        ...
        var newTextureOffset = textureAnimation.CurrentFrame + textureProperties[textureIndex].GroupPosition;
        newTextureOffset = textureAnimation.TotalFrames > 0 ? newTextureOffset % textureAnimation.TotalFrames : newTextureOffset;
